 ...
 *
 * @brief Function to mimic Service Room
 *
 *	Function acts as a sercice room by providing resoures to guests and keeps a log of it
 */
#include <stdio.h>
#include <stdlib.h>
#include <sys/types.h>
...
void serveGuest(int item)
{
    ...
    while(1)
    {
        ...
        if( masterBreak[0] ){
            printf("Master break on Service Room %d \n", item);
            return ;
            break;
        }
