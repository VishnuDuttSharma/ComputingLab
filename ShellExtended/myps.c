...
@param None. Additional option "-a" can be provided as input for listing
	all processes

@brief  Lists all proceses along with details
	Details provided:
	1. PID
...
/**
\fn void gerDevMap(int major, int minor)


@param major: a major number, found using linux/kdev_t.h
@param minor: a minor number, found using linux/kdev_t.h

@return Void

@brief Device mapping with number provided in file description
...
/**
\fn int openProc(int curr)

@param curr: if 1: only processes owned by current owner are listed
...
/**
@brief The function reads the file available in '/proc' directory
*/
